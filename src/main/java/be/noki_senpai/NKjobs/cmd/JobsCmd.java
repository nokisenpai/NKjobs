package be.noki_senpai.NKjobs.cmd;

import be.noki_senpai.NKjobs.cmd.Jobs.*;
...
public class JobsCmd implements CommandExecutor
{
	...
	{
		String usageCmd = "\n" + ChatColor.GREEN + "Liste des commandes pour " + ChatColor.RED + NKjobs.PNAME + ChatColor.GREEN + "\n----------------------------------------------------";
