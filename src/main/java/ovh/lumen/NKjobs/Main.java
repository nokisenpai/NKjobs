package ovh.lumen.NKjobs;

import java.io.File;

import ovh.lumen.NKjobs.completers.JobsCompleter;
import ovh.lumen.NKjobs.listeners.*;
...
public class Main extends JavaPlugin implements PluginMessageListener
{
	...
	@Override public void onEnable()
	{
		...
		if(!new File(getDataFolder() + "/blocksTimer.yaml").isFile())
		{
			this.saveResource("blocksTimer.yaml", false);
		}
		...
		// Event
		getServer().getPluginManager().registerEvents(new PlayerListener(manager.getPlayerManager()), this);
		...
		getCommand("jobs").setTabCompleter(new JobsCompleter(manager.getJobManager()));
