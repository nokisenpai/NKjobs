package ovh.lumen.NKjobs.completers;

import ovh.lumen.NKjobs.data.Job;
...
public class JobsCompleter implements TabCompleter
{

	JobManager jobManager = null;
	List<String> jobs = new ArrayList<String>();

	public JobsCompleter(JobManager jobManager)
	{
